...
function Sidebar() {
  ...
  return (
    ...
    <div className="fixed top-18 left-0 h-screen  md:w-80 bg-[#c2c5c4] text-white z-50">
      <button
      ...
      <nav className={`${isOpen ? 'block' : 'hidden'} lg:block`}>
        <ul className="py-4">
          <li className="px-6 py-3 mx-3 mb-3 text-lg font-medium bg-[#10312b21] hover:bg-[#10312b] hover:rounded-lg shadow-x1 active:scale-90 translation duration-300">
            <a href="/Sidebar">Home</a>
          </li>
          <li className="group relative dropdown  px-6 py-3 mx-3  mb-3 text-lg font-medium bg-[#10312b21] hover:bg-[#10312b] hover:rounded-lg shadow-x1 active:scale-90 translation duration-300" >
          ...
          <li className="group relative dropdown px-6 py-3 mx-3  mb-3 text-lg font-medium bg-[#10312b21]   hover:bg-[#10312b] hover:rounded-lg shadow-x1 active:scale-90 translation duration-150" >
          ...
          <li className="group relative dropdown  px-6 py-3 mx-3  mb-3 text-lg font-medium bg-[#10312b21] hover:rounded-lg  hover:bg-[#10312b] shadow-x1 active:scale-90 translation duration-150" >
            <a href="#">Add Exam</a>
          ...
          <li className="px-6 py-3 mx-3  mb-3  text-lg font-medium bg-[#10312b21] hover:rounded-lg hover:bg-[#10312b] shadow-x1 active:scale-90 translation duration-150">
            <a href="#">Books</a>
          </li>
        </ul>
      </nav>
